...
#' @param grouping_var_var Identity information to use for grouping_var_var.
...
#'
#' @description Given a palette name and data frame with clustering or grouping_var_var
#' information in an 'ident' column, return a palette containing a color for each
#' unique cluster identity.
#'
